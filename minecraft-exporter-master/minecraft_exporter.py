...
white_list = {
    'd30b5be6-ed17-36b9-9a97-8f73b59b85d2': 'sapfir',
    'f03bd45e-7d7b-3955-b370-c91dc8f06a9a': 'Pupsik',
    '75f41576-c9ae-3be1-9e5a-f6091a7fa867':'123'
}
...
class MinecraftCollector(object):
    def __init__(self):
        ...
        self.better_questing = "/data/world/world/betterquesting"
        ...
        print(os.environ['RCON_HOST'], os.environ['RCON_PASSWORD'], os.environ['RCON_PORT'])
    ...
    def update_metrics_for_player(self, uuid):
        ...
        name = white_list[uuid] if uuid in white_list else uuid
...
if __name__ == '__main__':
    ...
    while True:
        try:
            ...
            # RCON timeout
            print('disconnected from rcon collector')
